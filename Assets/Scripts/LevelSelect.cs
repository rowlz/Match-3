...
public class LevelSelect : MonoBehaviour
{
    ...
    private int seventhLevelStars;
    private int eigthLevelStars;
    ...
    public void GetLevelStarPrefs()
    {
        ...
        sixthLevelStars = PlayerPrefs.GetInt("Level6 Obstacles", 0);
        seventhLevelStars = PlayerPrefs.GetInt("Level7 Moves", 0);
        eigthLevelStars = PlayerPrefs.GetInt("Level8 Timer", 0);
        ninthLevelStars = PlayerPrefs.GetInt("Level9 Timer", 0);
        tenthLevelStars = PlayerPrefs.GetInt("Level10 Obstacles", 0);

        totalLevelStars = firstLevelStars + secondLevelStars + thirdLevelStars + fourthLevelStars + fifthLevelStars + sixthLevelStars + seventhLevelStars + eigthLevelStars + ninthLevelStars + tenthLevelStars;
